...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Strings that are less than the average of the lengths of all strings : ");
        printStringsWhoseLengthIsLessThanAverage(stringArray, valueOfArithmeticMeanLengthOfAllStrings);
